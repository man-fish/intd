...
var Button = function (props) {
    var _a;
    var btnType = props.btnType, size = props.size, className = props.className, href = props.href, disabled = props.disabled, children = props.children, restProps = __rest(props, ["btnType", "size", "className", "href", "disabled", "children"]);
